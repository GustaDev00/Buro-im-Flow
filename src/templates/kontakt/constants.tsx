...
export default {
  header: {
    title: (
      <>
        Kontaktieren Sie Büro im Flow –<CustomBr byViewport="desktop" /> Ich bin für Sie da
      </>
    ),
    description: (
      <>
        Ob Sie Fragen haben, eine Beratung wünschen oder direkt einen Termin
        <CustomBr byViewport="desktop" /> vereinbaren möchten – ich bin Ihr verlässlicher Partner
        für Treuhand-
